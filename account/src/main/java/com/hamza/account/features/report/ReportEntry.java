...
public enum ReportEntry {
    ...
    ITEMS_RANK(ReportSection.SALES, "report.dashboard.item.sales.rank.stage.title", "report.hub.describe.items.rank",
            ProductFeatures.REPORT_ITEMS, AppPermissions.REPORTS_SHOW_ITEMS),
    ITEMS_DAILY(ReportSection.SALES, "report.daily.item.sales.title", "report.hub.describe.items.daily",
