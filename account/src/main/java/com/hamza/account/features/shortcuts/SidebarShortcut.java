...
public enum SidebarShortcut {
    ...
    REPORT_HUB(""), REPORT_SUMMARY("Ctrl+8"), REPORT_ITEMS(""), REPORT_ITEMS_DAILY(""), REPORT_MONTHLY_TOTALS(""), REPORT_PARTY_PAYMENTS(""), REPORT_YEARLY(""), REPORT_PROFIT_LOSS(""), REPORT_RETURN_REASONS(""),
