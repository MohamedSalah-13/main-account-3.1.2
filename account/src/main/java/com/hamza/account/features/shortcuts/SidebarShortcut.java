...
public enum SidebarShortcut {
    ...
    TREASURIES(""), CURRENCIES(""), TREASURY_TRANSFER(""), TREASURY_CASH(""), TREASURY_CAPITAL(""), TREASURY_DETAILS("Ctrl+7"), TREASURY_PROCESS(""), EXPENSES(""),
    REPORT_HUB(""), REPORT_SUMMARY("Ctrl+8"), REPORT_ITEMS(""), REPORT_ITEMS_DAILY(""), REPORT_SALES_YEAR(""), REPORT_PURCHASE_YEAR(""), REPORT_CUSTOMER_PAID(""), REPORT_SUPPLIER_PAID(""), REPORT_YEARLY(""), REPORT_PROFIT_LOSS(""), REPORT_RETURN_REASONS(""),
