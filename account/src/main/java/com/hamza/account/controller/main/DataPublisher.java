 ...
 * {@code EventBus}, under {@code account.features.events}. These three stay: they
 * say "show or hide the totals box", "the background image changed" and
 * "the shift changed", which are
