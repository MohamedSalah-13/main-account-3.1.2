    ...
    class SalesFamily {
        ...
        void lineQueries() {
            ...
            assertEquals("UPDATE sales SET num=?,type=?,quantity=?,price=?,buy_price=?,total_sel_price=?,"
                    ...
                    + "price_foreign=?,discount_foreign=?,list_price=?,offer_id=?,offer_discount=?,offer_quantity=? "
        ...
        void lineStatement() {
            assertEquals("INSERT INTO sales (invoice_number,num,type,quantity,price,buy_price,total_sel_price,"
                    ...
                    + "discount_foreign,list_price,offer_id,offer_discount,offer_quantity) "
                    + "VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)",
                    lines.insertListSql());
        }
        ...
        void lineParameters() throws DaoException {
            ...
            // The offer that wrote its discount, that offer's part of it (V85), and the units it covered (V86).
            line.setOfferId(7);
            line.setOfferDiscount(new BigDecimal("5.00"));
            line.setOfferQuantity(new BigDecimal("2.000"));
            ...
            assertArrayEquals(new Object[]{
                    ...
                    new BigDecimal("55.00"), 7, new BigDecimal("5.00"), new BigDecimal("2.000")}, data);
        }
    ...
    class SalesReturnFamily {
        ...
        void lineQueries() {
            ...
            assertEquals("UPDATE sales_re SET item_id=?,type=?,quantity=?,price=?,buy_price=?,total_sel_price=?,"
                    + "total_buy_price=?,total_profit=?,discount=?,type_value=?,expiration_date=?,"
                    + "source_line_id=?,price_foreign=?,discount_foreign=?,offer_id=?,offer_discount=?,offer_quantity=? "
        ...
        void lineParameters() {
            ...
            assertArrayEquals(new Object[]{
                    ...
                    null, null, null, null, BigDecimal.ZERO, BigDecimal.ZERO}, data);
        }
    }
