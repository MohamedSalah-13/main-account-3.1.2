...
class ModelPurityArchitectureTest {
    ...
    private static final Set<String> MODELS_STILL_CARRYING_JAVAFX = Set.of(
            ...
            "com/hamza/account/model/base/BaseTarget.java",
            ...
            "com/hamza/account/model/domain/Customers.java",
            ...
            "com/hamza/account/model/domain/Purchase.java",
            ...
            "com/hamza/account/model/domain/SubGroups.java",
            "com/hamza/account/model/domain/SupplierAccount.java",
            "com/hamza/account/model/domain/Total_Buy_Re.java",
            "com/hamza/account/model/domain/Total_Sales.java",
            "com/hamza/account/model/domain/Total_Sales_Re.java",
