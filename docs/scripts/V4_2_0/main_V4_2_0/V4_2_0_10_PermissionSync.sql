...
-- =====================================================================
INSERT IGNORE INTO permission (code, name_ar, module, action, description, sort_order, active) VALUES
('purchase.show', 'عرض الشراء', 'purchase', 'show', 'عرض الشراء', 1, 1),
...
('total.purchase.show.invoice', 'عرض فاتورة مجموع الشراء', 'total.purchase', 'show.invoice', 'عرض فاتورة مجموع الشراء', 10, 1),
('total.purchase.print.invoice', 'طباعة فاتورة الشراء', 'total.purchase', 'print.invoice', 'طباعة فاتورة الشراء', 11, 1);

-- =====================================================================
-- 2) PURCHASE RETURNS (مردودات المشتريات) - 8 صلاحيات
-- =====================================================================
INSERT IGNORE INTO permission (code, name_ar, module, action, description, sort_order, active) VALUES
('purchase.re.show', 'عرض مردودات الشراء', 'purchase.return', 'show', 'عرض مردودات الشراء', 12, 1),
...
('total.purchase.re.show', 'عرض مجموع مردودات الشراء', 'total.purchase.return', 'show', 'عرض مجموع مردودات الشراء', 16, 1),
('total.purchase.re.create', 'إضافة إجمالي مردود شراء', 'total.purchase.return', 'create', 'إضافة إجمالي مردود شراء', 17, 1),
('total.purchase.re.update', 'تعديل مجموع مردود الشراء', 'total.purchase.return', 'update', 'تعديل مجموع مردود الشراء', 18, 1),
('total.purchase.re.delete', 'حذف مجموع مردود الشراء', 'total.purchase.return', 'delete', 'حذف مجموع مردود الشراء', 19, 1);

-- =====================================================================
-- 3) SALES (المبيعات) - 11 صلاحيات
-- =====================================================================
INSERT IGNORE INTO permission (code, name_ar, module, action, description, sort_order, active) VALUES
('sales.show', 'عرض المبيعات', 'sales', 'show', 'عرض المبيعات', 20, 1),
...
('sales.show.buy.price', 'عرض سعر الشراء في المبيعات', 'sales', 'show.buy.price', 'عرض سعر الشراء في المبيعات', 25, 1),
...
-- =====================================================================
INSERT IGNORE INTO permission (code, name_ar, module, action, description, sort_order, active) VALUES
('sales.return.show', 'عرض مردودات المبيعات', 'sales.return', 'show', 'عرض مردودات المبيعات', 31, 1),
...
('total.sales.return.show', 'عرض مجموع مردودات المبيعات', 'total.sales.return', 'show', 'عرض مجموع مردودات المبيعات', 35, 1),
('total.sales.return.create', 'إضافة إجمالي مردود بيع', 'total.sales.return', 'create', 'إضافة إجمالي مردود بيع', 36, 1),
('total.sales.return.update', 'تعديل مجموع مردود البيع', 'total.sales.return', 'update', 'تعديل مجموع مردود البيع', 37, 1),
('total.sales.return.delete', 'حذف مجموع مردود البيع', 'total.sales.return', 'delete', 'حذف مجموع مردود البيع', 38, 1);

-- =====================================================================
-- 5) ITEMS (الأصناف) - 10 صلاحيات
-- =====================================================================
INSERT IGNORE INTO permission (code, name_ar, module, action, description, sort_order, active) VALUES
('items.show', 'عرض الأصناف', 'items', 'show', 'عرض الأصناف', 39, 1),
...
-- =====================================================================
INSERT IGNORE INTO permission (code, name_ar, module, action, description, sort_order, active) VALUES
('main.group.show', 'عرض المجموعات الرئيسية', 'main.group', 'show', 'عرض المجموعات الرئيسية', 49, 1),
...
-- =====================================================================
INSERT IGNORE INTO permission (code, name_ar, module, action, description, sort_order, active) VALUES
('units.show', 'عرض الوحدات', 'units', 'show', 'عرض الوحدات', 57, 1),
...
-- =====================================================================
INSERT IGNORE INTO permission (code, name_ar, module, action, description, sort_order, active) VALUES
('stock.show', 'عرض المخازن', 'stock', 'show', 'عرض المخازن', 61, 1),
...
-- =====================================================================
INSERT IGNORE INTO permission (code, name_ar, module, action, description, sort_order, active) VALUES
('suppliers.show', 'عرض الموردين', 'suppliers', 'show', 'عرض الموردين', 71, 1),
...
-- =====================================================================
INSERT IGNORE INTO permission (code, name_ar, module, action, description, sort_order, active) VALUES
('customers.show', 'عرض العملاء', 'customers', 'show', 'عرض العملاء', 79, 1),
...
('customers.receipt.update', 'تعديل تحصيل من العميل', 'customers', 'receipt.update', 'تعديل تحصيل من العميل', 85, 1),
...
-- =====================================================================
INSERT IGNORE INTO permission (code, name_ar, module, action, description, sort_order, active) VALUES
('treasury.show', 'عرض الخزائن', 'treasury', 'show', 'عرض الخزائن', 88, 1),
...
('treasury.withdraw.update', 'تعديل سحب من الخزينة', 'treasury', 'withdraw.update', 'تعديل سحب من الخزينة', 96, 1),
...
-- =====================================================================
INSERT IGNORE INTO permission (code, name_ar, module, action, description, sort_order, active) VALUES
('expenses.show', 'عرض المصروفات', 'expenses', 'show', 'عرض المصروفات', 102, 1),
...
-- =====================================================================
INSERT IGNORE INTO permission (code, name_ar, module, action, description, sort_order, active) VALUES
('employees.show', 'عرض الموظفين', 'employees', 'show', 'عرض الموظفين', 107, 1),
...
-- =====================================================================
INSERT IGNORE INTO permission (code, name_ar, module, action, description, sort_order, active) VALUES
('reports.sales', 'تقارير المبيعات', 'reports', 'sales', 'تقارير المبيعات', 115, 1),
('reports.sales.daily', 'تقرير المبيعات اليومية', 'reports', 'sales.daily', 'تقرير المبيعات اليومية', 116, 1),
('reports.sales.monthly', 'تقرير المبيعات الشهرية', 'reports', 'sales.monthly', 'تقرير المبيعات الشهرية', 117, 1),
('reports.sales.comprehensive', 'تقرير المبيعات الشامل', 'reports', 'sales.comprehensive', 'تقرير المبيعات الشامل', 118, 1),

('reports.purchases', 'تقارير المشتريات', 'reports', 'purchases', 'تقارير المشتريات', 119, 1),
('reports.purchases.daily', 'تقرير المشتريات اليومية', 'reports', 'purchases.daily', 'تقرير المشتريات اليومية', 120, 1),
('reports.purchases.monthly', 'تقرير المشتريات الشهرية', 'reports', 'purchases.monthly', 'تقرير المشتريات الشهرية', 121, 1),
...
('reports.inventory.min.quantity', 'تقرير الحد الأدنى للكمية', 'reports', 'inventory.min.quantity', 'تقرير الحد الأدنى للكمية', 125, 1),
...
('reports.customers.receivables', 'مديونيات العملاء', 'reports', 'customers.receivables', 'مديونيات العملاء', 128, 1),
...
('reports.profit.monthly', 'تقرير الأرباح الشهرية', 'reports', 'profit.monthly', 'تقرير الأرباح الشهرية', 138, 1),
...
-- =====================================================================
INSERT IGNORE INTO permission (code, name_ar, module, action, description, sort_order, active) VALUES
('users.show', 'عرض المستخدمين', 'users', 'show', 'عرض المستخدمين', 145, 1),
...
-- =====================================================================
INSERT IGNORE INTO permission (code, name_ar, module, action, description, sort_order, active) VALUES
('roles.show', 'عرض الأدوار', 'roles', 'show', 'عرض الأدوار', 153, 1),
...
-- =====================================================================
INSERT IGNORE INTO permission (code, name_ar, module, action, description, sort_order, active) VALUES
('shifts.open', 'فتح وردية', 'shifts', 'open', 'فتح وردية', 159, 1),
...
-- =====================================================================
INSERT IGNORE INTO permission (code, name_ar, module, action, description, sort_order, active) VALUES
('settings.company', 'إعدادات الشركة', 'settings', 'company', 'إعدادات الشركة', 164, 1),
...
-- =====================================================================
INSERT IGNORE INTO permission (code, name_ar, module, action, description, sort_order, active) VALUES
('targets.show', 'عرض الأهداف', 'targets', 'show', 'عرض الأهداف', 171, 1),
...
-- =====================================================================
INSERT IGNORE INTO permission (code, name_ar, module, action, description, sort_order, active) VALUES
('pos.access', 'الوصول لنقاط البيع', 'pos', 'access', 'الوصول لنقاط البيع', 176, 1),
...
-- =====================================================================
INSERT IGNORE INTO permission (code, name_ar, module, action, description, sort_order, active) VALUES
('audit.view', 'عرض سجل المراجعة', 'audit', 'view', 'عرض سجل المراجعة', 180, 1),
...
SELECT 'تم إضافة الصلاحيات بنجاح!' AS status, COUNT(*) AS total_permissions FROM permission;
