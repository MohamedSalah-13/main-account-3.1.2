...
- [ ] الأيقونات التي لمستها Ikonli، وما لم يبقَ له مرجع من الصور حُذف
...
مستوفيًا القواعد الستّ التالية**. لا تفتح ملفًا لتطبيقها وحدها، ولا تتركه دونها.
...
### ق-ل5 — الخدمة لا تُركّب نصًّا للمستخدم
...
### ق-ل6 — لا صنف داخلي مجهول ينفّذ واجهة شاشة
...
| ق-ل5 | `LocalizationArchitectureTest` | 264 نصًّا في 31 ملفًا تحت `features/` — لا تزيد |
